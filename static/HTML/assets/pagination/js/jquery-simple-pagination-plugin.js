...
//Grid Items Pagination script
$.fn.postsPagination = function(options)
{
	var settings = $.extend({}, $.fn.postsPagination.defaults, options);
...
$.fn.postsPagination.defaults = {
	...
	//
	first_content: '<i class="fa fa-angle-left icon"></i>',  //e.g. '<<'
	previous_content: 'Prev',  //e.g. '<'
	next_content: 'Next',  //e.g. '>'
	last_content: '<i class="fa fa-angle-right icon"></i>', //e.g. '>>'
...
// End Grid Items Pagination Script	




//List Items Pagination script
$.fn.listPagination = function(options)
{
	var settings = $.extend({}, $.fn.listPagination.defaults, options);
...
// End List Items Pagination Script	
